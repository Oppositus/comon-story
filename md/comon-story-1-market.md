...
Но само по себе «92.7 % мертвы» — некорректный вывод, и это важно оговорить сразу, до главы 2. Значительная часть архива — вообще не проигравшие стратегии:
...
Больше четверти архива — это не «система торговала и проиграла», а «человек зарегистрировал стратегию и не начал». Считать их погибшими нельзя: они описывают поведение авторов при регистрации, а не выживаемость торговых систем. В главе 2 они вынесены в отдельный класс и исключены из знаменателя.
...
Половина всех стратегий площадки за всю свою жизнь торговала 36 дней или меньше. На такой истории невозможно отличить умение от везения — и это не наша придирка, а измеримый факт: в главе 3 показано, сколько лет наблюдения нужно, чтобы результат стал информативным.
...
Порог входа — вторая структурная характеристика. Медианный минимум для стратегий с тарифом от СЧА — 30 000 ₽, для комбинированных — 218 000 ₽. Забегая вперёд: порог входа окажется **сильнейшим из заранее видимых признаков витрины, связанных с качеством** (глава 5). Не единственным — частота сделок связана с качеством тоже, — но самым сильным.
...
Просадка совпадает тождественно, доходность — почти. Плохой выбор публики (глава 5) нельзя списать на дезинформацию в цифрах: цифры на месте.
...
Последняя структурная деталь, без которой глава 2 была бы неверной.
...
**Третье. Уровень ставки.** 6 % годовых от активов — это не «немного за удобство». При медианном валовом результате живых стратегий 10.6 % годовых плата съедает **треть заработанного**, а у 29.2 % прибыльных стратегий — больше половины (глава 5). Ставка не зависит ни от волатильности, ни от дохода, поэтому она тем разрушительнее, чем спокойнее стратегия: заработавший 46 % при высоком риске отдаёт седьмую часть, заработавший 15 % при низком — почти всё преимущество над вкладом.
...
- **Запрет клонов** (совпадение портфеля и действий больше чем на 75 %) и блокировка за многократное создание краткосрочных стратегий — это прямо против «фабрик», которые в главе 4 окажутся заметной частью популяции.
...
- **Экстремальные ряды**: встречаются артефакты вроде итога +2 877 000 % за 4 года. Для медиан безвредно, но там, где считаются распределения качества, применяется явный фильтр (глава 3).
...
**Массового подрисовывания истории задним числом нет.** Это критично: если бы бэктестовые хвосты были массовыми, вся глава 2 была бы фикцией.
...
Дневной ряд стратегии — это счёт автора **до** платы за следование. Полный расчёт «сколько остаётся подписчику» — в главе 5.
