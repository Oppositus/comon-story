...
*Небольшая вставка между [главами 4](comon-story-4-authors.md) и [5](comon-story-5-buyers.md). Здесь впервые в серии появляются данные не с Comon: живые стратегии Т-Инвестиций, посчитанные тем же способом, что и всё остальное. В конце — короткий взгляд и на остальные сервисы рынка: что их витрины показывают человеку, который ещё не клиент.*
...
*«Измеримых» — по [фильтру измеримости](comon-story-0-intro.md) серии; у Т-Инвестиций фильтр не применяется, потому что коротких и неактивных рядов там почти нет. Максимум 37 — среди живых стратегий; за всю историю Comon рекорд одного автора 167 ([глава 4](comon-story-4-authors.md)), но у Т мёртвых стратегий не видно, и сравнивать с ними нечего.*
...
**Про число 0.18 нужно объясниться сразу**, иначе оно выглядит противоречием: в [главе 3](comon-story-3-returns.md) у живых стратегий Comon стоит медианный Sharpe 0.36. Обе цифры верны, и обе про одни и те же 1 262 стратегии. Разница в конвенции. Sharpe — это дробь «доходность на единицу риска», и числитель в ней можно брать двумя способами: как среднюю дневную доходность, приведённую к году (так считает [глава 3](comon-story-3-returns.md)), или как фактический годовой прирост капитала, CAGR (так считает эта интерлюдия). Второй способ строже — он учитывает, что убытки и прибыли перемножаются, а не складываются, и потому даёт меньшее число у волатильных стратегий. Здесь мы взяли строгий вариант, потому что он одинаково применим к обеим площадкам. **На вывод выбор не влияет:** в арифметической конвенции те же величины дают 1.44 у Т-Инвестиций против 0.36 у Comon — разрыв четырёхкратный вместо восьмикратного, но никуда не девается.

### Не короткая ли история всё объясняет

Первое подозрение очевидное: стратегии Т-Инвестиций моложе, а [глава 3](comon-story-3-returns.md) показала, что **короткая история льстит** — на годовой дистанции встречаются Sharpe, которых на пятилетней не бывает. Проверяем прямо: сравниваем внутри одинаковых корзин по длине ряда.
...
Эффект длины у Т-Инвестиций виден отчётливо и ведёт себя ровно так, как предсказывает [глава 3](comon-story-3-returns.md): с 2.31 на коротких историях до 1.13 на длинных. Это лишний раз подтверждает, что закономерность рыночная, а не свойство одной площадки. **Но разрыв она не объясняет:** даже в самой длинной корзине, где обе площадки представлены сопоставимо (34 стратегии против 535), медианы различаются вчетверо.
...
Что именно создаёт разрыв — отбор авторов на входе, отсутствие архива, из-за которого мы не видим неудачных, или и то и другое, — по этим данным разделить нельзя. Скажем прямо: **мы знаем, что витрина Т-Инвестиций выглядит существенно лучше, и не знаем, какая часть этого — качество, а какая — невидимость неудачных.** Один намёк всё же есть: у Comon мы цену невидимости измерили — ошибка выжившего стоит 0.2–0.3 пункта Sharpe ([глава 3](comon-story-3-returns.md)). Разрыв между площадками больше пункта.
...
**У Comon есть то, чего нет у Т-Инвестиций, и это важнее всего перечисленного:** архив закрытых стратегий с сохранёнными кривыми. Именно он сделал возможными [главы 2](comon-story-2-survival.md) и [3](comon-story-3-returns.md) — и именно поэтому исследование написано на данных Comon, а не конкурента. Площадка, которая не прячет своих мертвецов, даёт покупателю то, чего не даст никакая карточка: возможность увидеть, чем всё это обычно заканчивается.
...
| Просадка счёта автора | «прогнозируемая просадка» (не просадка — [глава 1](comon-story-1-market.md)) | есть |
